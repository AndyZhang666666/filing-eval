...
import { CLAIM_LABELS, KEY_FACT_TYPES, RUBRIC_VERSION, coverageRate, weightedHallucinationRate } from "./rubric.js";
...
export const PROMPT_VERSIONS = { v1: PROMPT_V1, "v1.1": PROMPT_V1_1 };
export const CURRENT_PROMPT = process.env.JUDGE_PROMPT || "v1.1";

export function buildJudgePrompt({ source, summary, promptVersion = CURRENT_PROMPT }) {
  const body = PROMPT_VERSIONS[promptVersion] || PROMPT_VERSIONS["v1.1"];
